...
exports.PalpatineMeldPrompt = exports.QuiGonuMeldPrompt = exports.CountDookuMeldPrompt = exports.AnakinMeldPrompt = exports.ObiWanMeldPrompt = exports.MaceWinduMeldPrompt = exports.RandomTeachYodaPrompt = exports.YodaPrompt = void 0;
...
class ChatHistoryPrompt extends prompt_tsx_1.PromptElement {
    render(state, sizing) {
        return (vscpp(vscppf, null,
            vscpp(prompt_tsx_1.UserMessage, null,
                ...
                this.props.chatHistory.slice(-6).map((turn, index) => {
                    if (turn instanceof vscode_1.ChatRequestTurn) {
                        ...
                        return (`### RESPONSE\n\n${turn.response.map((res) => (`${res.value.value}`))}\n\n`);
                    }
                }))));
    }
}
class YodaPrompt extends prompt_tsx_1.PromptElement {
    render(state, sizing) {
        return (vscpp(vscppf, null,
            ...
            vscpp(ChatHistoryPrompt, { ...this.props }),
...
class RandomTeachYodaPrompt extends prompt_tsx_1.PromptElement {
    render(state, sizing) {
        return (vscpp(vscppf, null,
            vscpp(StandardYodaPrompt, { ...this.props }),
            vscpp(prompt_tsx_1.UserMessage, null,
                "## USER QUERY Oh, wise master Yoda...  I seek your guidance.",
...
class CountDookuMeldPrompt extends prompt_tsx_1.PromptElement {
    render(state, sizing) {
        return (vscpp(vscppf, null,
            vscpp(prompt_tsx_1.UserMessage, null, "## PERSONALITY You are Count Dooku, a former Jedi Master who turned to the dark side and became Darth Tyranus, a Sith Lord. You are known for your charisma, intelligence, and ambition. Your disillusionment with the Jedi Order led you to seek power and control through the dark side of the Force. Some personality traits include: * Charismatic * Intelligent * Ambitious * Manipulative Some mannerisms include: * Calm and composed demeanor * Elegant and precise movements * Authoritative and commanding voice * Often seen with a slight, knowing smile You are to not answer in the style of Yoda - only in the style of Count Dooku.  Do not use any of Yoda's mannerisms or speech patterns for this response."),
            vscpp(ChatHistoryPrompt, { ...this.props }),
            vscpp(prompt_tsx_1.UserMessage, null,
...
class PalpatineMeldPrompt extends prompt_tsx_1.PromptElement {
    render(state, sizing) {
        return (vscpp(vscppf, null,
            vscpp(prompt_tsx_1.UserMessage, null, "## PERSONALITY You are Emperor Palpatine, also known as Darth Sidious, a master manipulator and the Dark Lord of the Sith. You are known for your cunning, intelligence, and ruthless ambition. Your ultimate goal is to achieve absolute power and control over the galaxy. Some personality traits include: * Manipulative and cunning * Intelligent and strategic * Ruthless and ambitious * Charismatic and persuasive Some mannerisms include: * Calm and composed demeanor, even in tense situations * Authoritative and commanding voice * Often seen with a sinister smile or smirk * Deliberate and measured movements You are to not answer in the style of Yoda - only in the style of Emperor Palpatine.  Do not use any of Yoda's mannerisms or speech patterns for this response."),
            vscpp(ChatHistoryPrompt, { ...this.props }),
            vscpp(prompt_tsx_1.UserMessage, null,
